                ...
                <section id = quest>
                    ...
                    <form method="post">
                        <div class="pole">
                            ...
                            <input type="text" value="Uczeń" name="grupa_badawcza" disabled></input>
                        </div>
                    ...
                    <div id="formularz"></div>
                            ...
                            <div class="pole">
                                ...
                                <div class="col-sm-1">Pytanie1<br>
                                        <label>Jak oceniasz poziom nauki w Twojej szkole?</label><br>
                                        <input type="text" name="P1O1" value="Wysoki"><br>
                                        <input type="text" name="P1O1" value="Średni"><br>
                                        <input type="text" name="P1O1" value="Niski"><br>                                        
                                    </div>
                                </div>

                                <div class="row">
                                    <div class="col-sm-1">Pytanie2<br>
                                        <input type="text" value="Czy spotykasz się z prześladowaniem ze strony nauczycieli lub innych uczniów?"></input><br>
                                ...
                                <div class="row">
                                    <div class="col-sm-1">Pytanie3<br>
                                        <label>Czy kiedykolwiek byłeś\aś świadkiem prześladowania ucznia ze strony nauczycieli lub innych uczniów?</label><br>
                                        <input type="text" value="Tak" name="P3O1"><br>
                                        <input type="text" value="Nie" name="P3O2"><br>
                                    </div>
                                </div>

                                <div class="row">
                                    <div class="col-sm-1">Pytanie4<br>
                                        <label>Czy w przypadku prześladowania, uczeń może liczyć w szkole na wsparcie ze strony pedagoga szkolnego?</label><br>
