...
<html lang="pl">
    ...
    <body>
        <main>
        <div id="scenter">
            <h1>WYBIERZ FORMĘ ANKIETY</h1><br><br><br>
            <a href="kreator_a.php">Ankieta - pytania zamknięte</a><br>
            <a href="kreator_b.php">Ankieta - pytania otwarte</a><br>
            <a href="kreator_c.php">Ankieta mix pytań</a>
        </div>
