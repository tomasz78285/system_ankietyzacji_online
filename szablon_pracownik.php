                ...
                <section id = quest>
                    ...
                    <form method="post">
                        <div class="pole">
                            ...
                            <input type="text" value="Pracownik" name="grupa_badawcza" disabled></input>
                        </div>
                    ...
                    <div id="formularz"></div>
                            ...
                            <div class="pole">
                                ...
                                <div class="col-sm-1">Pytanie1<br>
                                        <label>Jak oceniasz atmosferę w Twojej pracy?</label><br>
                                        <input type="text" name="P1O1" value="Dobrze"><br>
                                        <input type="text" name="P1O1" value="Źle"><br>                                  
                                    </div>
                                </div>

                                <div class="row">
                                    <div class="col-sm-1">Pytanie2<br>
                                        <label>Czy spotykasz się z prześladowaniem ze strony przełożonych?</label><br>
                                ...
                                <div class="row">
                                    <div class="col-sm-1">Pytanie3<br>
                                        <label>Czy kiedykolwiek byłeś\aś świadkiem faforyzowania innych pracowników ze względu na płeć, kolor skóry, itp.?</label><br>
                                ...
                                <div class="row">
                                    <div class="col-sm-1">Pytanie4<br>
                                        <label>Czy jesteś zadowolony ze swojej obecnej pensji?</label><br>
