                ...
                <section id = quest>
                    ...
                    <form method="post">
                        <div class="pole">
                            ...
                            <input type="text" value="Biznes" name="grupa_badawcza" disabled></input>
                        </div>
                    ...
                    <div id="formularz"></div>
                            ...
                            <div class="pole">
                                ...
                                <div class="col-sm-1">Pytanie1<br>
                                        <label>Jakiej atrakcji brakuje w twojej okolicy?</label><br>
                                        <input type="text" name="P1O1" disabled><br>
                                ...
                                <div class="row">
                                    <div class="col-sm-1">Pytanie2<br>
                                        <label>Jak lubisz spędzać wolny czas?:</label><br>
                                        <input type="text" value="Sport" name="P2O1"><br>
                                        <input type="text" value="Czytając" name="P2O2"><br>
                                        <input type="text" value="Kino" name="P2O3"><br>
                                        <input type="text" value="Inne" name="P2O4"><br>
                                    </div>
                                </div>

                                <div class="row">
                                    <div class="col-sm-1">Pytanie3<br>
                                        <label>Jak często wychodzisz na miasto?</label><br>
                                        <input type="text" value="Codziennie" name="P3O1"><br>
                                        <input type="text" value="Kilka razy w tygodniu" name="P3O2"><br>
                                        <input type="text" value="Raz na tydzień" name="P3O3"><br>
                                        <input type="text" value="Raz na miesiąc" name="P3O3"><br>
                                        <input type="text" value="Wogóle nie wychodzę, chyba że muszę" name="P3O4"><br>
                                    </div>
                                </div>

                                <div class="row">
                                    <div class="col-sm-1">Pytanie4<br>
                                        <label>Ile pieniędzy przeznaczasz na rozrywkę miesięcznie?</label><br>
                                        <input type="text" value="Dużo" name="P4O1"><br>
                                        <input type="text" value="Mało" name="P4O2"><br>
