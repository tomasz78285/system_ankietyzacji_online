    ...
    <body>
        ...
        <main>
            <section class="rodzaj_ankiet">
                <div class = "container">
                    <from method="post">
                        <h1>Zarządzaj ankietami</h1>
                        <lable>Wybierz ankietę, którą chcesz usunąć</label>
                        <select name="nazwa">
                                    <?php
                                        ...
                                        $sql = "SELECT nazwa_ankiety FROM ankiety";
                                        $result = $polaczenie->query($sql);
                                        
                                        if($result && $result->num_rows > 0) {
                                            while($row = $result->fetch_assoc()) {
                                                echo "<option>".$row["nazwa_ankiety"]."</option>";
                                            }
                                        } else {
                                            echo "0 results";
                                        }
                        ...
                        {
                            $ankieta = $_POST['nazwa'];
                            $polaczenie->query("DELETE FROM ankiety WHERE nazwa_ankiety='$ankieta'");
                            echo "Usunięto ankietę";                        }
                         ?>
                    <div class="row">
