    ...
    <?php
        ...
        if(isset($_POST['nazwa_ankiety']) &&  isset($_POST['P1'])  && isset($_POST['P101'])) 
        {
            ...
            $polaczenie->query("INSERT INTO pytania (tresc_pytania, nr_pytania_w_ankiecie, rodzaj ,ankieta) VALUES 
                                                                                ('$P1','1','multi','$nazwa_ankiety'),
                                                                                ('$P2','2','multi','$nazwa_ankiety'),
                                                                                ('$P3','3','multi','$nazwa_ankiety'),
                                                                                ('$P4','4','multi','$nazwa_ankiety'),
                                                                                ('$P5','5','multi','$nazwa_ankiety'),
                                                                                ('$P6','6','multi','$nazwa_ankiety'),
                                                                                ('$P7','7','multi','$nazwa_ankiety'),
                                                                                ('$P8','8','multi','$nazwa_ankiety'),
                                                                                ('$P9','9','multi','$nazwa_ankiety'),
                                                                                ('$P10','10','multi','$nazwa_ankiety')");
                    ...
                    <div id="scenter">
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-1">Pytanie3<br>
                                    ...
                                    <label>Odpowiedzi:</label>
                                    <input type="text" name="P301"><br>
                                    <input type="text" name="P302"><br>
                                    <input type="text" name="P303"><br>
                                    <input type="text" name="P303"><br>
                                    <input type="text" name="P304"><br>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-1">Pytanie6<br>
                                ...
                                <label>Odpowiedzi:</label>
                                <input type="text" name="P601"><br>
                                <input type="text" name="P602"><br>
                                <input type="text" name="P603"><br>
                                <input type="text" name="P604"><br>
                                <input type="text" name="P605"><br>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-1">Pytanie10<br>
                                ...
                                <label>Odpowiedzi:</label>
                                <input type="text" name="P1001"><br>
                                <input type="text" name="P1002"><br><br>  
                            </div>
                        </div>
